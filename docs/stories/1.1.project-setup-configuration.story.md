...
- [x] Configure app.json with application metadata (AC: 3)
  - [x] Set appropriate app name for TodoMorning
  - [x] Configure bundle ID (e.g., `com.todomorning.app`)
...
4. **App Configuration**: 
   - `app.json` configured with name "TodoMorning" and bundleIdentifier "com.todomorning.app"
...
3. **AC 3 - App Metadata**
   ...
   - **Then:** `name` field contains "TodoMorning" (or appropriate app name) and `bundleId` follows convention (e.g., `com.todomorning.app`)
...
| 3 | `app.json` configured with app name and bundle ID | ✅ PASS | Name: "TodoMorning", Bundle ID: "com.todomorning.app" |
